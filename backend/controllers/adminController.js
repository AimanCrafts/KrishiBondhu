...
const DEFAULT_CONTENT = [
  ...
  },
  {
    ...
    desc: "Alert / announcement text shown to all farmers (leave blank to hide)",
    value: "",
  },
  {
    key: "buyer_alert",
    ...
    desc: "Alert / announcement text shown to all buyers (leave blank to hide)",
    value: "",
  },
  {
    key: "market_notice",
    ...
    desc: "Notice text shown at the top of the marketplace page",
    value: "",
  },
];
...
const getContent = async (req, res) => {
  try {
    ...
    if (blocks.length === 0) {
      blocks = await Content.insertMany(DEFAULT_CONTENT);
    }
