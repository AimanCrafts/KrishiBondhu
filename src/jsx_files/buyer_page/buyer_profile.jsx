...
export default function BuyerProfile() {
  ...
  useEffect(() => {
    fetch("/api/buyer/content/buyer_alert")
      .then((r) => r.json())
      .then((d) => {
        if (d.value) setAdminAlert(d.value);
      })
      .catch(() => {});
  }, []);
      ...
      <div className="bp-page">
        ...
        {adminAlert && (
          <div className="bp-admin-alert">
            ...
            <div>
              <strong>Admin Notice:</strong> {adminAlert}
            </div>
          </div>
        )}
        ...
        <div className="bp-page-header bp-reveal" ref={addRef}>
          ...
          <div className="bp-header-info">
            <div className="bp-header-company">
              {form.companyName || "Your Company"}
            </div>
            <div className="bp-header-role">
              <i className="fa-solid fa-building" />{" "}
              {form.businessType || "Food Business"}
            ...
            <div className="bp-header-badges">
              <span className="bp-badge bp-badge-verified">
                <i className="fa-solid fa-shield-halved" /> Verified Business
              </span>
              <span className="bp-badge bp-badge-active">
        ...
        {activeTab === "profile" && (
          <form
            className="bp-form-section bp-reveal"
            ref={addRef}
            onSubmit={handleSave}
          >
              ...
              <div className="bp-form-card-header">
                ...
                <div>
                  ...
                  <div className="bp-card-sub">
                    Edit your business details. These are visible to farmers you
                    connect with.
                  </div>
                </div>
              </div>
              ...
              <div className="bp-form-grid">
                <div className="bp-field">
                  ...
                  <input
                    ...
                    placeholder="e.g. Rahman Food Industries"
                  />
                </div>
                <div className="bp-field">
            ...
            <div className="bp-form-card">
              <div className="bp-form-card-header">
                ...
                <div>
                  ...
                  <div className="bp-card-sub">
                    Tell us what crops you buy — we'll surface matching farmer
                    listings and price alerts.
                  </div>
                </div>
              </div>
              ...
              <div className="bp-pref-section">
                ...
                <div className="bp-crop-grid">
                  {CROP_INTERESTS.map((crop) => (
                    ...
                    >
                      {form.cropInterests.includes(crop) && (
                  ...
                  {[
                    {
                      id: "price_alert",
                      label: "Price Alerts",
                      desc: "Notify me when my preferred crops change in price by 3%+",
                    },
                    {
                      id: "new_listing",
                      label: "New Listings",
                      desc: "Notify me when new farmers list my preferred crops",
                    },
                    {
                      id: "order_update",
                      label: "Order Updates",
                      desc: "Notify me on order status changes",
                    },
                    {
                      id: "weekly_digest",
                      label: "Weekly Digest",
                      desc: "Weekly market summary and procurement tips",
                    },
                  ].map((pref) => (
          ...
          <div className="bp-form-section bp-reveal" ref={addRef}>
            <div className="bp-form-card">
              ...
              <form onSubmit={handlePasswordChange}>
                ...
                {pwError && (
                  <div className="bp-pw-error">
                    <i className="fa-solid fa-triangle-exclamation" /> {pwError}
                  </div>
                )}
                <div className="bp-form-actions">
                  <button type="submit" className="bp-save-btn">
                ...
                <div className="bp-danger-row">
                  <div>
                    ...
                    <div className="bp-danger-desc">
                      Your account will be suspended. Contact admin to
                      reactivate.
                    </div>
                  </div>
                  <button
                    ...
                    onClick={() =>
                      alert("Contact admin@krishibondhu.com to deactivate.")
                    }
                  >
                    Deactivate
                  </button>
        ...
        <div className="bp-account-meta bp-reveal" ref={addRef}>
          <div className="bp-meta-item">
            <i className="fa-solid fa-calendar" /> Member since January 2024
          </div>
          <div className="bp-meta-item">
            <i className="fa-solid fa-id-badge" /> Buyer ID:{" "}
            {user?._id || "BUY-00001"}
          </div>
          <div className="bp-meta-item">
            <i className="fa-solid fa-shield-halved" /> Account status:{" "}
